...
This repository contains four quantitative research tasks modeled after real workflows used in commodities markets, risk analytics, and credit modeling. All work is performed in Jupyter Notebooks for transparency and reproducibility.

Tasks Summary Task 1 – Natural Gas Forecasting & Price Estimation
...
Project Structure My-Industry-Project-Experience/ │ ├── data/ │
...
Clone the Repository git clone https://github.com/athirajaan-source/My-Industry-Project-Experience.git cd My-Industry-Project-Experience
...
Results Summary Task 1 – Gas Forecasting
